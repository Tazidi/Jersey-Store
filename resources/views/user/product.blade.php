                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="category" name="category">
                                                    ...
                                                    <option value="Jersey NBA">Jersey NBA</option>
                                                    <option value="Jersey IBL">Jersey IBL</option>
                                                    <option value="Jersey FIBA">Jersey FIBA</option>
                                                    <option value="Jersey Custom">Jersey Custom</option>
                                                    <option value="Kaos Jersey Basket">Kaos Jersey Basket</option>
                                                    <option value="Aksesoris Basket">Aksesoris Basket</option>
                                                    <option value="Perlengkapan Basket">Perlengkapan Basket</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
