    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mb-3">
                <h1 class="text-warning">ETERNAL JERSEY STORE</h1>
                {{-- <img src="/assets/img/logo-hypermart-main-1.png" alt=""> --}}
                <p class="text-light">ETERNAL JERSEY STORE merupakan platform perbelajaan berbagai fashion kekinian dan memberikan
            ...
            <div class="col-md-2 mb-3">
                ...
                <div class="social-media d-flex gap-3">
                    <a href="https://www.instagram.com/rizkitazidi_/" target="_blank" class="fs-4"><i
                            class="fa-brands fa-instagram"></i></a>
                    <a href="https://wa.me/087728476945" class="fs-4"><i class="fa-brands fa-whatsapp"></i></a>
                    <a href="https://github.com/Tazidi" target="_blank" class="fs-4"><i
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <p class="text-light">Kelompok 02 Kelas AA</p>
            </div>
        </div>
    </div>
</footer>
